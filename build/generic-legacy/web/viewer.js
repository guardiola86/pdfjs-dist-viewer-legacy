...
const PDFViewerApplication = {
  ...
  async _initializeViewerComponents() {
    var _appConfig$sidebar, _appConfig$secondaryT, _appConfig$sidebar2, _appConfig$sidebar3, _appConfig$sidebar4;
    const {
      appConfig,
      externalServices
    } = this;
...
function webViewerInitialized() {
  ...
  if (!PDFViewerApplication.supportsPrinting) {
    var _appConfig$toolbar, _appConfig$secondaryT2;
    (_appConfig$toolbar = appConfig.toolbar) === null || _appConfig$toolbar === void 0 ? void 0 : _appConfig$toolbar.print.classList.add("hidden");
    (_appConfig$secondaryT2 = appConfig.secondaryToolbar) === null || _appConfig$secondaryT2 === void 0 ? void 0 : _appConfig$secondaryT2.printButton.classList.add("hidden");
  }
  if (!PDFViewerApplication.supportsFullscreen) {
    var _appConfig$secondaryT3;
    (_appConfig$secondaryT3 = appConfig.secondaryToolbar) === null || _appConfig$secondaryT3 === void 0 ? void 0 : _appConfig$secondaryT3.presentationModeButton.classList.add("hidden");
  }
